...
layui.define(['jquery', 'larryElem', 'layer', 'common'], function(exports) {
  ...
  LarryTab.prototype.init = function() {
    ...
    $(window).on('resize', function() {
      ...
      $('#larry_body').height($('#larry_admin_out').height()-60);
      ...
      $('#larry_tab_content').width($('#larry_tab').width()).height($('#larry_tab').height() - $('#larry_title_box').height()-40);
  ...
  function getHtml(data, topStatus) {
    ...
    if (topStatus == 'on') {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        ulHtml.top += '<a data-id="' + data[i].id + '" data-group="' + i + '"">';
        ...
        if (data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0) {
          ...
          for (var j = 0; j < data[i].children.length; j++) {
            ...
            if (data[i].children[j].children !== undefined && data[i].children[j].children !== null && data[i].children[j].children.length > 0) {
              ulHtml.left[i] += '<a data-id="' + data[i].children[j].id + '">';
              ...
              for (var k = 0; k < data[i].children[j].children.length; k++) {
                ...
                ulHtml.left[i] += '<a data-id="' + data[i].children[j].children[k].id + '" data-url="' + data[i].children[j].children[k].url + '">';
              ...
              ulHtml.left[i] += '<a data-id="' + data[i].children[j].id + '" ' + dataUrl + '>';
              if (data[i].children[j].icon !== undefined && data[i].children[j].icon !== '') {
                // 暂时只定义一种用法
                ulHtml.left[i] += '<i class="larry-icon" data-icon="' + data[i].children[j].icon + '">' + data[i].children[j].icon + '</i>';
              }
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0) {
          ...
          for (var j = 0; j < data[i].children.length; j++) {
            ulHtml += '<dd>';
            ulHtml += '<a data-id="' + data[i].children[j].id + '" data-url="' + data[i].children[j].url + '">';
            if (data[i].children[j].icon !== undefined && data[i].children[j].icon !== '') {
          ...
          ulHtml += '<a data-id="' + data[i].id + '" ' + dataUrl + '>';
          ulHtml += '<i class="larry-icon" data-icon="' + data[i].icon + '">' + data[i].icon + '</i>';
          ulHtml += '<cite>' + data[i].title + '</cite>';
          ulHtml += '</a>';
        }
