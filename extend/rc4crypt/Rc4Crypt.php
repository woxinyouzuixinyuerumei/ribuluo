...
class Rc4Crypt {
    ...
    public function __construct()
    {
        ...
        $this->setKey(md5("NAP0-MKLO-CVGY-HYUK-NANK-DERT-3ZAQ-JTYY"));
    }
     ...
     * @access public
     * @param String $key
     * md5("QUFOUCOM-2007G2WGQ-4WDK3-PJKPW-98VXX-THFMJ")
     */
    function setKey($key="106cd72547dd80e165b7e132687a4c37")
    {
        $this->key = $key;
